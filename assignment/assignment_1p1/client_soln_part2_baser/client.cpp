        ...
        if ( cur_path_len > 1 ) {
            ...
            */
            for(int i = 1; i<cur_path_len; i++){
              int32_t lcd_start_x = longitude_to_x(current_map_num, waypoints[i-1].lon)-screen_map_x;
              int32_t lcd_start_y = latitude_to_y(current_map_num,waypoints[i-1].lon)-screen_map_y;
              if (is_waypoints_visible(lcd_start_x,lcd_start_y)){
                int32_t lcd_end_x = longitude_to_x(current_map_num, waypoints[i].lon)-screen_map_x;
                int32_t lcd_end_y = latitude_to_y(current_map_num,waypoints[i].lon)-screen_map_y;
                tft.drawLine(lcd_start_x,lcd_start_y,lcd_end_x,lcd_end_y,YELLOW);
                }
